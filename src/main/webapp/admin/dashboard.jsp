...
<div class="container-fluid">
    <div class="row">
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse p-3">
            ...
            <hr>
            <a href="../index.jsp" class="btn btn-danger w-100 fw-bold shadow-sm mt-2">
                ...
                <div class="col-md-4">
                    <div class="card p-3">
                        <div class="d-flex align-items-center">
                            <div class="stat-icon bg-primary bg-opacity-10 text-primary me-3"><i class="bi bi-box-seam-fill"></i></div>
                            <div><h6 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.8rem;">Total Paket</h6><h2 class="fw-bold mb-0 text-dark"><%= totalPaket %></h2></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3">
                        <div class="d-flex align-items-center">
                            <div class="stat-icon bg-warning bg-opacity-10 text-warning me-3"><i class="bi bi-truck-front-fill"></i></div>
                            <div><h6 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.8rem;">Sedang Diantar</h6><h2 class="fw-bold mb-0 text-dark"><%= onProcess %></h2></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div><h6 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.8rem;">Berhasil Terkirim</h6><h2 class="fw-bold mb-0 text-dark"><%= sukses %></h2></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td class="fw-bold" style="color: #003366;"><%= p.getNoResi() %></td>
