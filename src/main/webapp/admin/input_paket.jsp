    ...
    <body>
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                    ...
                    <div class="d-md-none d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" style="background-color: #FF9900; border: none; color: #003366;">
                    ...
                    <div class="alert alert-success alert-dismissible fade show shadow-sm border-0">
                        <i class="bi bi-check-circle-fill me-2"></i> <strong>Berhasil!</strong> Data paket telah tersimpan.
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                    <% } else if ("gagal".equals(request.getParameter("status"))) { %>
                    <div class="alert alert-danger alert-dismissible fade show shadow-sm border-0">
                        <i class="bi bi-exclamation-triangle-fill me-2"></i> <strong>Gagal!</strong> Periksa data kembali.
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                    <% }%>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" id="beratInput" step="0.1" name="berat" class="form-control" oninput="hitungBiaya()" required>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="layananInput" name="layanan" onchange="hitungBiaya()">
                                            ...
                                            %>
                                            <option value="" data-harga="0">❌ DATA KOSONG / ERROR</option>
                                            <%
                                            } else {
                                                for (Layanan l : listLay) {
                                            %>
                                            <option value="<%= l.getNamaLayanan()%>" data-harga="<%= l.getHargaPerKg()%>">
                                                <%= l.getNamaLayanan()%>
                                            </option>
                                            <%
                                                    }
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold">Isi Paket</label>
                                        <input type="text" name="isi_paket" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold text-success">Total Biaya</label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-success border-success text-white">Rp</span>
                                            <input type="number" id="biayaInput" name="biaya" class="form-control fw-bold text-success border-success" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-3 mt-5">
                                    ...
                                    <button type="submit" class="btn btn-primary px-5 py-2 fw-bold shadow" style="background-color: #FF9900; border: none; color: #003366;">
        ...
        <script>
                function generateResi() {
                    document.getElementById('resiInput').value = "AMB-" + Math.floor(100000 + Math.random() * 900000);
                }
                ...
                function hitungBiaya() {
                    ...
                    if (select.selectedIndex !== -1) {
                        hargaPerKg = parseFloat(select.options[select.selectedIndex].getAttribute('data-harga')) || 0;
                    }
